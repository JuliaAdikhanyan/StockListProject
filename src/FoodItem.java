...
public class FoodItem extends GenericItem { // наследуем класс FoodItem от класса GenericItem
    ...
    // конструктор
    FoodItem(int tempId, String tempName, float tempPrice, FoodItem tempAnalog,
             Category tempCategory, GregorianCalendar tempDateOfIncome, short tempExpires) {
    ...
    public void printAll() {
        ...
        System.out.println("---ID: " + getId() + " ---Name: " + getName() + " ---Price: " + getPrice() + " ---Analog: "
                + getAnalog().getName() + " ---Category: " + getCategory() + " ---DateOfIncome: "
                + dateFormat.format(dateOfIncome.getTime()) + " ---Expires: " + expires + " days");
    }
